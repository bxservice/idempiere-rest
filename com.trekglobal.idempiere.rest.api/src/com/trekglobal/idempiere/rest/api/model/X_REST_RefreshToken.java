...
public class X_REST_RefreshToken extends PO implements I_REST_RefreshToken, I_Persistent 
{
    ...
    public X_REST_RefreshToken (Properties ctx, int REST_RefreshToken_ID, String trxName)
    {
      super (ctx, REST_RefreshToken_ID, trxName);
      /** if (REST_RefreshToken_ID == 0)
        {
        } */
    }

    /** Standard Constructor */
    public X_REST_RefreshToken (Properties ctx, int REST_RefreshToken_ID, String trxName, String ... virtualColumns)
    {
      super (ctx, REST_RefreshToken_ID, trxName, virtualColumns);
      /** if (REST_RefreshToken_ID == 0)
        {
        } */
    }
